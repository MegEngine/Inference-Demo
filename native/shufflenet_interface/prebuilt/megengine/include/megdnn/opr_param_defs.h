// generated by gen_param_defs.py for 7084e95d77c4a12dc67f3e4473c0f62b87ed635a65533f3aa4ef0ce32194b6b9
#pragma once
...
struct ConvolutionV0 {
    ...
    static MEGDNN_CONSTEXPR uint32_t FORMAT_NR_MEMBER = 12;
    union { struct {
    Mode mode;
...
struct Elemwise {
    ...
    static MEGDNN_CONSTEXPR uint32_t MODE_NR_MEMBER = 52;
    union { struct {
    Mode mode;
    }; };
...
struct MatrixMul {
    ...
    static MEGDNN_CONSTEXPR uint32_t FORMAT_NR_MEMBER = 3;
    union { struct {
    bool transposeA;
    bool transposeB;
    ComputeMode compute_mode;
...
struct Winograd {
    ...
    Winograd(uint32_t output_block_size_=0, Format format_=Format::DEFAULT) {
        memset(this, 0, sizeof(*this));
        this->output_block_size = output_block_size_;
        this->format = format_;
    }
...
struct RelayoutFormat {
    ...
    */
    ...
    static MEGDNN_CONSTEXPR uint32_t MODE_NR_MEMBER = 22;
    union { struct {
    Mode mode;
    }; };
